...
class Pointer(nn.Module):
    ...
    def __init__(self, hidden_size, num_layers=1, dropout=0.2):
        ...
        ##GRU es una red neuronal recurrente con múltiples capas: https://pytorch.org/docs/stable/generated/torch.nn.GRU.html#torch.nn.GRU
    ...
    def forward(self, static_hidden, dynamic_hidden, decoder_hidden, last_hh):
        ...
        ##torch.bmm -> realiza el productp de dos matrices (por lotes)
