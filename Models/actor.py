...
class DRL4TSP(nn.Module):
    ...
    """
    ##Dropout es un método de regularización que aproxima el entrenamiento en paralelo de un gran número de redes neuronales con diferentes arquitecturas.
    ##Durante el entrenamiento, un cierto número de salidas de capa se ignoran o "descartan" aleatoriamente.
    ...
    def __init__(self, static_size, dynamic_size, hidden_size,
        ...
        for p in self.parameters():
            if len(p.shape) > 1:
                ...
                # Rellena el Tensor de entrada con valores según
                # el método descrito en Understanding the difficulty of training deep feedforward neural networks - Glorot, X. & Bengio, Y. (2010),
    ...
    def forward(self, static, dynamic, decoder_input=None, last_hh=None):
        ...
        ##Uso de Métodos de enmascaramiento:
        ...
        for _ in range(max_steps):
            ...
            if self.training:
                m = torch.distributions.Categorical(probs) ##varible categórica (se utiliza para dividir el entorno en clases --> clasificación multiclase realizada por la función softmax y que se corresponde al output de la red neuronal)
